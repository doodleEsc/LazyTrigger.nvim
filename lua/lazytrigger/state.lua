...
---Saves the state in the global _G.LazyTrigger.state object.
---
---@private
function state:save()
    log.debug("state.save", "saving state globally to _G.LazyTrigger.state")

    _G.LazyTrigger.state = self
end
...
---Whether the LazyTrigger is enabled or not.
---
